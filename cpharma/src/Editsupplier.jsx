...
function Editsupplier(props) {  
    console.log(props.match.params.supplierId)
        ...
        const Url = "http://localhost:46152/api/Supplier/" +props.match.params.supplierId;  
        ...
        const UpdateSupplier = (e) => {  
          ...
          axios.put('http://localhost:46152/api/Supplier/'+props.match.params.supplierId, data)  
            .then((result) => {  
